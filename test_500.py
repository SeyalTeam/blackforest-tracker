...
old_throw = "throw Exception('Failed to update employee role: ${res.statusCode}');"
new_throw = "throw Exception('Failed to update employee role: ${res.statusCode} ${res.body}');"
